    ...
    public ConnectionFactory connectionFactory() {
        try {
            ...
            return ConnectionFactories.get(ConnectionFactoryOptions.builder()
                    ...
                    .option(HOST, Objects.requireNonNull(env.getProperty("REVIEWSVC_DB_HOST")))
                    .option(PORT, Integer.parseInt(Objects.requireNonNull(env.getProperty("REVIEWSVC_DB_PORT"))))
                    .option(USER, Objects.requireNonNull(env.getProperty("REVIEWSVC_DB_USER")))
                    .option(PASSWORD, Objects.requireNonNull(env.getProperty("REVIEWSVC_DB_PASSWORD")))
                    .option(DATABASE, Objects.requireNonNull(env.getProperty("REVIEWSVC_DB_DATABASE")))
                    .option(MAX_SIZE, 20)
                    .build());
        }
        catch (Exception e) {
